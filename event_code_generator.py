...
class_prefix = "TPP"
excel_file_path = "./event.xlsx"
analytic_manager_file_path = "./AnalyticsManager.m"
...
def registerEvents(events, analytics_file_path):
    ...
    with open('AnalyticsManager.m', 'w+') as f:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--ananlytics', type=str,help='File path for AnalyticsManager.m')
